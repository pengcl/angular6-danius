...
@Component({
  selector: 'app-banana-index-T',
  templateUrl: './index.component.html',
  styleUrls: ['./index.component.scss']
})
export class BananaIndexTComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.logSvc.log('load', this.submitForm.get('activeTag').value).then();
  ...
  setLess() {
    this.logSvc.log('setLess', this.submitForm.get('activeTag').value).then();
  ...
  setMore() {
    this.logSvc.log('setMore', this.submitForm.get('activeTag').value).then();
  ...
  setName() {
    this.logSvc.log('setName', this.submitForm.get('activeTag').value).then();
  }

  setMobile() {
    this.logSvc.log('setMobile', this.submitForm.get('activeTag').value).then();
  }

  setRoom() {
    this.logSvc.log('setRoom', this.submitForm.get('activeTag').value).then();
  }
  ...
  showPicker() {
    this.pickerSvc.showCity(DATA, '').subscribe(res => {
      ...
      this.logSvc.log('setAddress', this.submitForm.get('activeTag').value).then();
    });
  }
  ...
  submit() {
    ...
    this.logSvc.log('submit', this.submitForm.get('activeTag').value).then();
  }
